...
const router = (app) => {
  ...
  app.get('/get_copies_of_entry',
    middleware.RequiresLogin,
    controllers.Copy.GetCopiesOfEntry);
  app.get('/get_member',
    middleware.RequiresLogin,
  ...
  app.post('/remove_copy_entry',
    middleware.RequiresLogin,
    controllers.Copy.RemoveCopiesByEntry);
  ...
  app.post('/signin_entry',
    middleware.RequiresLogin,
    controllers.Copy.SignInByEntryID);
  app.post('/renew_copy',
    middleware.RequiresLogin,
